...
export function TestimonialsSection() {
  return (
    <section id="temoignages" className="px-6 py-24" aria-label="Temoignages">
      <div className="mx-auto max-w-6xl">
        <FadeIn>
          <div className="mb-4 text-sm font-medium uppercase tracking-widest text-primary">Temoignages</div>
        ...
        <FadeIn delay={200}>
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            {testimonials.map((testimonial) => (
              <blockquote key={testimonial.author} className="relative flex flex-col rounded-2xl border border-border bg-card p-8">
                {/* Quote icon */}

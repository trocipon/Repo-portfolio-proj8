...
import { MdMonitor, MdFlashOn, MdStorage, MdSpeed, MdRocketLaunch, MdViewKanban, MdDesignServices, MdInsights, MdNorthEast, MdSearch } from "react-icons/md";

export const GraduationCap = FaGraduationCap;
export const Quote = FaQuoteLeft;
export const Gauge = FaTachometerAlt;
...
export const Zap = MdFlashOn;
export const Server = MdStorage;
...
export const ArrowUpRight = MdNorthEast;

...
const services = [
  {
    ...
    description: "Creation de sites vitrines, portfolios et applications web modernes avec React et Next.js.",
  },
  {
    icon: Search,
...
function TechCarousel() {
  ...
  return (
    <div
      ref={scrollRef}
      className="mt-8 flex gap-3 overflow-hidden"
      onMouseEnter={() => setIsPaused(true)}
      onMouseLeave={() => setIsPaused(false)}
      role="marquee"
      aria-label="Technologies maitrisees"
    >

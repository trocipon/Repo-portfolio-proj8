    ...
    <footer className="relative border-t border-border bg-card px-6 py-12" role="contentinfo">
      <div className="mx-auto flex max-w-6xl flex-col items-center gap-6 md:flex-row md:justify-between">
        ...
        <p className="text-xs text-muted-foreground">
          {`\u00A9 ${currentYear} Thibaud Rocipon. Tous droits reserves.`}
        </p>
      </div>
      ...
      <a
        href="#accueil"
        className="absolute right-6 -top-5 flex h-10 w-10 items-center justify-center rounded-full border border-border bg-card text-muted-foreground shadow-sm transition-colors hover:text-primary hover:border-primary/30"
